const PRO_TIPS = [
  ...
  "You can often increase the area of effect of the Expendable Napalm by firing it at a wall or ceiling near a group of enemies, giving the bomblets more time to spread out.",
  ...
  "When driving the TD-220 Bastion, you can turn in place by only pressing the left or right directional buttons (A and D on keyboard).",
  "In the TD-220 Bastion, shooting an enemy that's too close with the main gun can heavily damage the tank.",
  ...
  "The Supply FRV comes with 8 supply packs. You can use a supply pack to reload the FRV's automated turret, which will point straight up and make a peculiar noise when it's out of ammunition.",
