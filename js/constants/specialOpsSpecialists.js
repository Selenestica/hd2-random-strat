const SPECOPSSPECS = [
  ...
  },
  {
    ...
    stratagems: ['Autocannon Sentry', 'HMG Emplacement', 'Shield Generator Relay', 'Mortar Sentry'],
    primary: ['Defender'],
  ...
  },
  {
    ...
    stratagems: ['GL-52 De-Escalator', 'Orbital EMS Strike', 'EMS Mortar Sentry', 'Guard Dog Arc'],
    primary: ['Halt'],
